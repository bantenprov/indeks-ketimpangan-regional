<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Indeks Ketimpangan Regional
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <vuetable ref="vuetable"
          api-url="/api/ketimpangan-regional"
          :fields="fields"
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/ketimpangan-regional/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/ketimpangan-regional/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/ketimpangan-regional/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/ketimpangan-regional/' + rowData.id)
